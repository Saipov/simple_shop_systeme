 ...
 */
final class Version20240319031645 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE products_discount (id BIGINT NOT NULL, coupon_code VARCHAR(255) NOT NULL, coupon_type VARCHAR(255) NOT NULL, value NUMERIC(10, 2) NOT NULL, is_active BOOLEAN DEFAULT false NOT NULL, date_start TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, date_end DATE DEFAULT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, archived_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, deleted_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, PRIMARY KEY(id))');
